    ...
    <div class="col-md-12">
     <div class="card">
      <div class="card-header">
       <h3 class="text-muted"><i class="fas fa-user-tag mr-sm-1"></i>비밀번호 검색</h3>
      </div>
      <div class="card-body">
           <div class="pagination justify-content-center">
     <form action="./passwordsearchview" method="post" id="signupForm" enctype="application/x-www-form-urlencoded">
        <fieldset>
           <div class="pagination justify-content-center">
          <div class="col col-md-12">
         <div class="form-group row">
          <label for="id" class="col-2 col-form-label pr-0"><i class="fas fa-user-check mr-sm-1"></i>아이디</label>
          <div class="col-8 pl-0">
           <input type="text" name="id" id="id" class="form-control" placeholder="아이디">
          </div>        
         </div>           
         <div class="form-group row">
          <label for="name" class="col-2 col-form-label pr-0"><i class="fas fa-envelope-open mr-sm-1"></i>이메일</label>
          <div class="col-8 pl-0">
          <div class="d-md-flex">
