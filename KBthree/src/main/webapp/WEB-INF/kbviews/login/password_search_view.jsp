     ...
     <div class="card">
      ...
      <div class="card-body">
       <div class="row  pt-3 pb-1 justify-content-center">
        <div class="col col-sm-8 text_strong text-center">검색한 아이디의 비밀번호입니다.</div>
       </div>
      ...
      <c:choose>
       <c:when test="${!empty memberDTO.pass}">
        <div class="row pb-1 justify-content-center">
        <p class="text"> 비밀번호는
         <b class="text-danger">${memberDTO.pass}</b>
        입니다. </p>
